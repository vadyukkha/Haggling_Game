...
Offer create_offer_book1(int cost_hat, int cost_book, int cost_ball)  {
    Offer offer;
    offer.hat = 1;
    offer.book = 1;
    offer.ball = 3;
...
Offer create_offer_book2(int cost_hat, int cost_book, int cost_ball)  {
    Offer offer;
    offer.hat = 1;
    offer.book = 0;
    offer.ball = 3;
...
Offer decide_on_offer_book1(const Offer& offer, int cost_hat, int cost_book, int cost_ball) {
    Offer new_offer;
    if (offer.book > 0) {
        new_offer.ball = 200;
        return new_offer;
    }
    return create_offer_book1(cost_hat, cost_book, cost_ball);
}

Offer decide_on_offer_book2(const Offer& offer, int cost_hat, int cost_book, int cost_ball) {
    Offer new_offer;
    if (offer.book > 0) {
        new_offer.ball = 200;
        return new_offer;
    }
    return create_offer_book2(cost_hat, cost_book, cost_ball);
}
...
extern "C" EXPORT int decide(int turn, int cost_hat, int cost_book, int cost_ball, int count_hat, int count_book, int count_ball) {
    int a = -1e9;
    if (turn == 0) {
        Offer offer = create_offer_book2(cost_hat, cost_book, cost_ball);
        ...
        Offer answer = decide_on_offer_book2(enemy_offer, cost_hat, cost_book, cost_ball);
